...
## 🌐 个人站点 · [xiaoyangtx.icu](https://xiaoyangtx.icu)

| 项目 | 描述 | 链接 |
|:---:|:---|:---:|
| **小杨导航** | 自托管导航管理系统，无限层级菜单、拼音搜索、WebDAV 云同步 | [演示](https://search.xiaoyangtx.icu) |
| **玄机阁** | 中华传统术数文化工具集，八字排盘、塔罗、AI 解读 | [演示](https://xuanjige.xiaoyangtx.icu) |
| **语战像素岛** | 像素风日语学习应用，游戏化成就与排行榜 | [演示](https://yzxsd.xiaoyangtx.icu) |
| **DDL 文档生成器** | DDL 解析与规范文档生成，支持驼峰格式转换 | [演示](https://ddl-doc-generator.xiaoyangtx.icu) |
| **要开心！** | 液态玻璃风趣味祝福页，分享链接自动生成 | [演示](https://happy.xiaoyangtx.icu) |
...
| 平台 | 项目 | 描述 | 技术栈 |
|:---:|:---|:---|:---|
| <img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" height="20"/> | [**goalcraft-skill**](https://github.com/xiaoyangtx996/goalcraft-skill) | 一句话需求 → 可执行 /goal YAML，只写提示词不执行 | `Agent Skill` `YAML` |
| <img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" height="20"/> | [**PromptSpark**](https://github.com/xiaoyangtx996/PromptSpark) | Composer 一键优化/还原提示词，多风格可接 OpenAI 兼容接口 | `JavaScript` |
| <img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" height="20"/> | [**TextTop**](https://github.com/xiaoyangtx996/TextTop) | Windows 桌面便签，托盘常驻、置顶与 Markdown | `TypeScript` `Tauri` `React` |
...
| 项目 | 在做什么 |
|:---|:---|
| [**goalcraft-skill**](https://github.com/xiaoyangtx996/goalcraft-skill) | 把一句话收成可执行 /goal YAML |
| [**PromptSpark**](https://github.com/xiaoyangtx996/PromptSpark) | Composer 提示词一键优化 |
| [**TextTop**](https://github.com/xiaoyangtx996/TextTop) | 桌面便签 · 托盘 · 置顶 |
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:7DD3FC,50:B8E6FE,100:E0F2FE&height=100&section=footer&animation=twinkling"/>
